    ...
    if (coinPrice.length === 0) {
        ...
        return (
            <div className="coin-prices">
                <div className="btc">
                    <img src={btcicon} className='coinicon' alt='bitcoin icon' /><h3 className='coinmain'>Bitcoin: ${coinPrice.bitcoin.usd}</h3>
                ...
                <div className="eth">
                    <img src={ethicon} className='coinicon' alt='ethereum icon' /><h3 className='coinmain'>Ethereum: ${coinPrice.ethereum.usd}</h3>
                ...
                <div className="xmr">
                    <img src={xmricon} className='coinicon' alt='xmr icon' /><h3 className='coinmain'>Monero: ${coinPrice.monero.usd}</h3>
                ...
                <div className="doge">
                    <img src={dogicon} className='coinicon' alt='doge icon' /><h3 className='coinmain'>Dogecoin: ${coinPrice.dogecoin.usd}</h3>
                ...
                <div className="cardano">
                    <img src={caricon} className='coinicon' alt='cardano icon' /><h3 className='coinmain'>Cardano: ${coinPrice.cardano.usd}</h3>
                ...
                <div className="polkadot">
                    <img src={pokicon} className='coinicon' alt='polkadot icon' /><h3 className='coinmain'>Polkadot: ${coinPrice.polkadot.usd}</h3>
